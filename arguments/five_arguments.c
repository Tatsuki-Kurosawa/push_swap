...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/28 17:23:30 by kurosawaits       #+#    #+#             */
/*   Updated: 2023/04/28 17:35:17 by kurosawaits      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sort(t_twoway_list **stack_a, t_twoway_list **stack_b, int index)
{
	...
	else if (index == 3)
	{
		...
		rra(stack_a);
	pb(stack_a, stack_b);
	four_arguments(stack_a, stack_b);
	pa(stack_a, stack_b);
}
...
void	five_arguments(t_twoway_list **stack_a, t_twoway_list **stack_b)
{
	int	index;
